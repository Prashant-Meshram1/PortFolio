        ...
        <div className={`${theme ? 'h-20 w-full bg-primary z-30 fixed' : 'h-20 w-full bg-black z-30 fixed'}`} >
            ...
            <ul>
                <div className="flex  justify-end relative top-[-47px] ">
                    <Link to=".">
                        <div className="bg-cyan-700  m-4 h-16 w-16 hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] rounded-xl flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <Link to="projects">
                        <div className=" bg-cyan-700 h-16  m-4  w-16 hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] rounded-xl flex flex-col justify-center items-center cursor-pointer">
                            <GoProjectSymlink className="h-6 w-6 text-white" />
                            <p className="text-white font-round  text-[13px]  ">Projects </p>
                        </div>
                    </Link>
                    <Link to="contacts">
                        <div className="h-16 w-16  m-4 bg-cyan-700 hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] rounded-xl flex flex-col justify-center items-center cursor-pointer ">
